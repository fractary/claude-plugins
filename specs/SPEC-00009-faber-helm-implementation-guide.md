...
### Core Architecture
- **[SPEC-00008: Faber Helm Architecture](./SPEC-00008-faber-helm-architecture.md)** - Vision, philosophy, and system boundaries
...
- **[SPEC-00007: Helm System Specification](./SPEC-00007-helm-system-specification.md)** - Complete Helm system design
  - 1778 lines covering: central Helm, domain plugins, workflows, dashboard, voice interface

### Migration Plan
- **[SPEC-00010: Faber Cloud Helm Migration](./SPEC-00010-faber-cloud-helm-migration.md)** - Multi-phase implementation roadmap
...
1. **Review:** Read core architecture document (SPEC-00008-faber-helm-architecture.md)
...
### Documentation
- [SPEC-00008-faber-helm-architecture.md](./SPEC-00008-faber-helm-architecture.md) - Vision & philosophy
- [SPEC-00007-helm-system-specification.md](./SPEC-00007-helm-system-specification.md) - Detailed Helm design
- [SPEC-00010-faber-cloud-helm-migration.md](./SPEC-00010-faber-cloud-helm-migration.md) - Migration roadmap
