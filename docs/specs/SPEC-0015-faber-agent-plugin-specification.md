...
# SPEC-0015: FABER Agent Plugin Specification
...
- Validate against SPEC-0014 (CLI argument standards)
...
- `docs/specs/SPEC-0014-cli-argument-standards.md` - CLI argument standards
