# SPEC-0031: Spec Naming Standards and GitHub Link Improvements
...
**Repository Standard:**
- Uses: `SPEC-0001-feature-name.md` (uppercase, 4-digit zero-padded)
- Examples in `/docs/specs/`:
  - `SPEC-0001-faber-plugin-implementation-plan.md`
  - `SPEC-0029-08-spec-plugin-architecture.md`
  - `SPEC-0030-01-codex-knowledge-retrieval-architecture.md`

**Mismatch:**
- Case: lowercase `spec` vs uppercase `SPEC`
- Padding: Variable digits (`84`) vs zero-padded 4 digits (`0084`)
- Namespace collision risk: Issue #123 creates `spec-123-*.md`, but standalone SPEC-0123 also exists
...
1. **Issue-Associated Specs** (generated from GitHub issues)
   ...
   - Examples:
     - Issue #84 → `WORK-00084-implement-feature.md`
     - Issue #1234 → `WORK-01234-fix-bug.md`
...
2. **Standalone Specs** (not tied to issues)
   ...
   - Examples:
     - Next available: `SPEC-0031-architecture-design.md`
     - Following: `SPEC-0032-data-model.md`
...
highest=$(ls docs/specs/SPEC-*.md 2>/dev/null |
          sed 's/.*SPEC-//' |
          sed 's/-.*//' |
...
# Result: "SPEC-0032-architecture-design.md"
```
...
assert_equal "$(generate_standalone_spec_name "architecture")" "SPEC-0031-architecture.md"
```
...
- **Existing Specs:** `docs/specs/SPEC-*.md`
...
```json
{
  "specs": [
    ...
    },
    {
      "id": "SPEC-0031",
      "type": "standalone",
      "path": "docs/specs/SPEC-0031-naming-standards.md",
      "status": "active"
    }
  ]
}
...
| Current | Remains |
|---------|---------|
| `SPEC-0001-faber.md` | `SPEC-0001-faber.md` |
| `SPEC-0031-naming.md` | `SPEC-0031-naming.md` |
