...
Invoke the docs-manage-standards skill directly with structured request:

```json
{
  "operation": "<create|update|list|validate|reindex>",
  "title": "<standard title or null for all>",
...
**Example for create**:
```
Use the docs-manage-standards skill to create standards documentation:
{
  "operation": "create",
...
```
Use the docs-manage-standards skill to list all standards documentation:
{
  "operation": "list",
  "project_root": "/path/to/project"
}
