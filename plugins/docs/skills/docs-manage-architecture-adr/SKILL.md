---
name: docs-manage-architecture-adr
...
**Schema**: `schemas/adr.schema.json`
**Storage**: Configured in `doc_types.adr.path` (default: `docs/architecture/ADR`)
**Naming Pattern**: `ADR-{number}-{slug}.md` (5-digit zero-padded, e.g., ADR-00001-...)
...
2. **Sequential Numbering**
   ...
   - ALWAYS use 5-digit zero-padded format (00001, 00002, 00003, etc.)
